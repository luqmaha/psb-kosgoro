...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Diterima Akuntansi</h3>
    </div>
</div>

<div class="btn-group" role="group" aria-label="...">
    <a href="print.php?rdr=laporan.pdfakt" target='_blank' title="Print PDF" class="btn btn-primary"><i class="fa fa-file-pdf-o fa-fw"></i> .PDF</a>
    <a href="../app/modul/excel/xlsakt.php" title="Eksport Excel" class="btn btn-success" style="background-color:#169F85;"><i class="fa fa-file-excel-o fa-fw"></i> .XLS</a>
</div>
    ...
    <div class="dataTable_wrapper">
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    <?php
                        $sql = mysqli_query($conn, "SELECT * FROM tb_siswa WHERE jurusan='AKT' ORDER BY jmlnilai DESC");
                        $no=0;
